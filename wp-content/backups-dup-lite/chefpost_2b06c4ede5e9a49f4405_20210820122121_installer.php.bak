...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'chefpost_2b06c4ede5e9a49f4405_20210820122121_archive.zip';
	const ARCHIVE_SIZE		 = '41105009';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2b06c4e-20122121';
    const SECONDARY_PACKAGE_HASH = 'a5b9406-20122121';
	const VERSION			 = '1.4.2';
